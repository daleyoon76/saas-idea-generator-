...
- **아이템 발굴 기준**
  - "바이브코딩 SaaS/Agent 아이템 발굴 기준" 문서(별도 asset)를 참조하여 아이디어 평가 기준을 설정한다.
  - 위 기준에 따라 가장 좋은 아이디어 3개를 도출한다.

- **사용 모델**
  - Default: **Google Gemini 3.0 Pro**
  - 사용자가 모델을 선택 변경할 수 있도록 옵션 제공
